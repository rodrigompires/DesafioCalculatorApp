...
const audioJump = new Audio('../sounds/Super Mario World - Jump Sound Effect.mp3');
const audioGameOver = new Audio('../sounds/Super Mario World - Game Over.mp3');
const audioMusic = new Audio('../sounds/Super Mario World Music - Overworld.mp3');
const audioTheme = new Audio('../sounds/Super Mario World Music - Opening Title.mp3');
const audioSpin = new Audio('../sounds/Super Mario World - Spin Sound Effect.mp3');
const audioVictory = new Audio('../sounds/Super Mario World Music - Course Clear Fanfare.mp3')
const audioItem = new Audio('../sounds/item.mp3');
const audioPrincess = new Audio('../sounds/Super Mario World Music - Castle Clear Demo.mp3');
...
const audioFireworks = new Audio('../sounds/Fogos de artifício -Efeitos sonoros.mp3');
...
const checkGameOver = setInterval(() => {
    ...
    if (blockOnLeftPosition >= 3 && blockOnLeftPosition <= 25 && marioPosition === 50) {
    ...
    if (blockOffLeftPosition >= 3 && blockOffLeftPosition <= 25 && marioPosition === 50) {
    ...
    const enemyGoombaPosition = +window.getComputedStyle($enemy).top.replace('px', '');
    let goombaLeftPosition = $goomba.offsetLeft;

  
    if (+enemyGoombaPosition.toFixed(2) === 162.8 || +enemyGoombaPosition.toFixed(2) === 162.79) {
    ...
    if (objPosition <= 32 && objPosition > 0 && marioPosition < 25 || goombaLeftPosition <= 32 && goombaLeftPosition > 0 && marioPosition < 25) {
...
function checkVictory() {
    const msgVictory = 'Congratulations! You saved the princess! Thanks for playing. Encoded by Rodrigo Pires 😎'
